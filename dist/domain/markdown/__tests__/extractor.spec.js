...
describe('MarkdownImageExtractor', () => {
    ...
    it('应该正确提取第一张图片的信息', () => {
        ...
        expect(firstImage.absolutePath).toBe(path.resolve(basePath, '260228-project-architecture.svg'));
    });
    it('应该正确提取第二张图片的信息', () => {
        const result = extractor.extract(testMarkdown);
        ...
        expect(secondImage.absolutePath).toBe(path.resolve(basePath, '260228-agent-architecture.svg'));
    });
    it('应该正确提取第三张图片的信息', () => {
        const result = extractor.extract(testMarkdown);
        ...
        expect(thirdImage.absolutePath).toBe(path.resolve(basePath, '260228-project-timeline.svg'));
    });
    it('应该正确处理 URL 图片', () => {
